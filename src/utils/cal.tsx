...
export const getDaysAgo = (createdAt: string) => {
  ...
  // Build pure Gregorian dates for the Jalali day (year/month/day only)
  ...
  // Helper: format Jalali date as "1403/05/22"
  ...
  if (diffDays === 0) {
    return (
      <p className="text-green-500">
        امروز <span className="font-mono">{formatJalali(cj)}</span>
      </p>
    );
  }
