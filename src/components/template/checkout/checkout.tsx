  ...
  return (
    <div className="grid grid-cols-12 gap-5 mt-8">
      <div className="col-span-8">
        <FormCheck allPrice={allPrice} userId={isUserLoggedIn?.id || ""} fullName={isUserLoggedIn?.fullName || ""} deliveryMethod={deliveryMethod} setDeliveryMethod={setDeliveryMethod} />
      </div>
