...
function SearchBar({removeProduct}: {removeProduct?: (id: string) => Promise<void>}) {
                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center justify-center gap-4">
                      <div>
                        <FaRegTrashCan className="text-red-500" onClick={() => removeProduct && removeProduct(item._id)} />
                      </div>
                      <div>
